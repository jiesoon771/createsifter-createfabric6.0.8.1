 ...
 */
package io.github.shulej.createsifter.ponders;
...
public class PonderScenes {
	public static void sifter(SceneBuilder scene, SceneBuildingUtil util) {
		...
		scene.world().createItemEntity(util.vector().blockSurface(beltPos, Direction.UP), util.vector().of(0, -0.05, 0), nugget);
		scene.idle(15);
		scene.world().createItemEntity(util.vector().blockSurface(beltPos, Direction.UP), util.vector().of(0, -0.05, 0), new ItemStack(Items.COAL));
		scene.idle(20);
