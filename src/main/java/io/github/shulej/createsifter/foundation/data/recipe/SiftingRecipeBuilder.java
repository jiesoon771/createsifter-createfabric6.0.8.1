...
public class SiftingRecipeBuilder {
	...
	public SiftingRecipeBuilder withCondition(ConditionJsonProvider condition) {
	...
	public static class DataGenResult implements FinishedRecipe {
		...
		public DataGenResult(SiftingRecipe recipe, List<ConditionJsonProvider> recipeConditions) {
			this.recipe = recipe;
